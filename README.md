...
- `main` - ~~Some modifications to the original source code, which are not yet merged into the upstream. Used by the [YGOPro](https://github.com/Fluorohydride/ygopro) project.~~ Current status TBD, should be based on `trunk`. It will be the default branch when YGOPro migrates to 1.9.
